"""
Django settings for cyberchat project.
...
SECRET_KEY = 'django-insecure-tookbjv1=w7i)7d1x+ugy5*_$=7#9fup-g5f3=f*2sf!drl=ys'
...
WSGI_APPLICATION = 'cyberchat.wsgi.application'
